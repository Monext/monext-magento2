...
class Constants
{
    ...
    const PAYMENT_BACK_CODES_RETURN_GET_WEB_PAYMENT_DETAILS_TRANSACTION_DUPLICATE = ['01913', '02001'];
    ...
    const PAYMENT_CONTRACT_CARD_TYPE_CADHOC = 'CADHOC';
    const PAYMENT_CONTRACT_CARD_TYPE_COFIDIS = 'COFIDIS';
    const PAYMENT_CONTRACT_CARD_TYPE_CASINO3X = 'CASINO_3XCB';
    const PAYMENT_CONTRACT_CARD_TYPE_CASINO4X = 'CASINO_4XCB';
    const PAYMENT_CONTRACT_CARD_TYPE_PAYCONIQ = 'PAYCONIQ';
    const PAYMENT_CONTRACT_CARD_TYPE_MULTIBANCO = 'MULTIBANCO';
    const PAYMENT_CONTRACT_CARD_TYPE_MBWAY = 'MBWAY';
    const PAYMENT_CONTRACT_CARD_TYPE_BANCONTACT = 'BANCONTACT';
    const PAYMENT_CONTRACT_CARD_TYPE_KLARNA_PAY = 'KLARNA_PAY';
    const PAYMENT_CONTRACT_CARD_TYPE_KLARNA = 'KLARNA';
    const PAYMENT_CONTRACT_CARD_TYPE_IDEAL = 'IDEAL';
    const PAYMENT_CONTRACT_CARD_TYPE_APPLEPAY = 'APPLE_PAY';
