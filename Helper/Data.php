...
class Data extends AbstractHelper
{
    ...
    public function getDefaultCategories() {
        return array(
            ...
            array( 'value' => '100010001', 'name' => __('Computer')),
            array( 'value' => '100010002', 'name' => __('Printer')),
            array( 'value' => '100010003', 'name' => __('To scan')),
            array( 'value' => '2', 'name' => __('Electronics - TV - Hifi')),
            array( 'value' => '20001', 'name' => __('Video')),
            array( 'value' => '200010001', 'name' => __('Camcorder')),
            array( 'value' => '200010002', 'name' => __('Video recorder')),
            array( 'value' => '200010003', 'name' => __('TV')),
            array( 'value' => '200010004', 'name' => __('LCD screen')),
            array( 'value' => '200010005', 'name' => __('Plasma screen')),
            array( 'value' => '200010006', 'name' => __('Home cinema')),
            array( 'value' => '200010007', 'name' => __('HIFI')),
            array( 'value' => '3', 'name' => __('Phone')),
            array( 'value' => '4', 'name' => __('Home appliance')),
            array( 'value' => '40001', 'name' => __('Cold')),
            array( 'value' => '400010001', 'name' => __('Fridge')),
            array( 'value' => '400010002', 'name' => __('Freezer')),
            array( 'value' => '40002', 'name' => __('Washing')),
            array( 'value' => '400020001', 'name' => __('Dishwasher')),
            array( 'value' => '400020002', 'name' => __('Washing machine')),
            array( 'value' => '400020003', 'name' => __('Tumble drier')),
            array( 'value' => '40003', 'name' => __('baking')),
            array( 'value' => '400030001', 'name' => __('cooker')),
            array( 'value' => '400030002', 'name' => __('Cooktop')),
            array( 'value' => '5', 'name' => __('Habitat and garden')),
            array( 'value' => '50001', 'name' => __('Heating')),
            array( 'value' => '500010001', 'name' => __('Radiator')),
            array( 'value' => '50002', 'name' => __('sanitary')),
            array( 'value' => '50003', 'name' => __('window frame')),
            array( 'value' => '500030001', 'name' => __('Shutter')),
            array( 'value' => '50004', 'name' => __('Garden tool')),
            array( 'value' => '500040001', 'name' => __('Mower')),
            array( 'value' => '500040002', 'name' => __('tiller')),
            array( 'value' => '500040003', 'name' => __('Chain saw')),
            array( 'value' => '500040004', 'name' => __('Hedge')),
            array( 'value' => '599990001', 'name' => __('Kitchen delivered without laying')),
            array( 'value' => '599990002', 'name' => __('Kitchen delivered')),
            ...
            array( 'value' => '110001', 'name' => __('Quad')),
            array( 'value' => '12', 'name' => __('furnishing')),
            array( 'value' => '120001', 'name' => __('Living room furniture')),
            array( 'value' => '1200010001', 'name' => __('Sofa')),
            array( 'value' => '1200010002', 'name' => __('Armchair')),
            array( 'value' => '1200010003', 'name' => __('cabinet')),
            array( 'value' => '1200010004', 'name' => __('Library')),
            array( 'value' => '120002', 'name' => __('Dining room furniture')),
            array( 'value' => '120003', 'name' => __('Bedroom')),
            array( 'value' => '1200030001', 'name' => __('Bedding')),
            array( 'value' => '120004', 'name' => __('Office furniture')),
            array( 'value' => '120005', 'name' => __('Upholstery fabric')),
            array( 'value' => '120006', 'name' => __('Kitchen furniture')),
            array( 'value' => '120007', 'name' => __('Bathroom furniture')),
            array( 'value' => '120008', 'name' => __('Garden furniture')),
            array( 'value' => '1200080001', 'name' => __('Barbecue')),
            ...
            array( 'value' => '170001', 'name' => __('Food (meal vouchers eligible products)')),
            array( 'value' => '170002', 'name' => __('Food (meal vouchers not eligible products)')),
            ...
            array( 'value' => '240001', 'name' => __('Music instrument')),
            array( 'value' => '2400010001', 'name' => __('Piano')),
            array( 'value' => '2400010002', 'name' => __('Organ')),
